  ...
  return (
    <div className="flex flex-col justify-center min-h-screen items-center w-full gap-8">
        <div className="flex justify-center gap-4">
            <div className="w-32 h-32 md:w-56 md:h-56 lg:w-72 lg:h-72 bg-zinc-200 rounded-xl flex flex-col justify-center items-center cursor-pointer hover:bg-zinc-400 transition-all duration-300">
